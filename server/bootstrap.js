...
// inventories, notes, notifications and an audit trail) so a
...
function seedDemo(admin, bre) {
  ...
  console.log('+ demo dataset (points, history, inventories, logs)…');
  ...
  tx();
  console.log('  demo: 5 точек, история смен, продажи, инвентаризации, заметки, уведомления и журнал готовы.');
}
